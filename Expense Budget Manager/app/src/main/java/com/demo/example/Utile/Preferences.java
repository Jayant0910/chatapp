...
import com.demo.example.DailyIncomeExpenseManager;
...
public class Preferences {
    ...
    private SharedPreferences mPrefs = DailyIncomeExpenseManager.getInstance().getSharedPreferences("hidvideo_preferences", 0);
    ...
    public void setLoginStatus(boolean z) {
        this.mEdit.putBoolean("pref_user_islogin", z);
        save();
    }
