...
public class MyUtils {
    public static String PREF_KEY_ACCOUNT = "account";
    ...
    public static String[][] language = {new String[]{"en", "English"}, new String[]{"hi", "हिन्दी"}, new String[]{"gu", "ગુજરાતી"}, new String[]{"fr", "français"}};
    ...
    public static boolean getWhatNewRequired(Context context) {
        ...
        return !loadData.equalsIgnoreCase(sb.toString());
    }
    ...
    public static int getLastCurrencyId(Context context) {
        ...
        for (int i = 0; i < currencyList.length; i++) {
            if (string.equalsIgnoreCase(currencyList[i][1])) {
                return i;
            }
        }
        return 0;
