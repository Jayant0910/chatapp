...
public class MyDatabaseHandler {
    ...
    public MyDatabaseHandler(Context context) {
        ...
        this.managerDB = new ManagerDBHelper(this.context);
        this.f70db = this.managerDB.getWritableDatabase();
    }
    ...
    public long addUpdateManagerData(DataBean dataBean) {
        ...
        if (TextUtils.isEmpty(dataBean.getId())) {
            return this.f70db.insert(ManagerTable.TABLE_NAME, null, contentValuesFromManagerModel);
        }
    ...
    public long addUpdateRecurringData(RecurringBean recurringBean) {
        ...
        if (TextUtils.isEmpty(recurringBean.getId())) {
            return this.f70db.insert(RecurringTable.TABLE_NAME, null, contentValuesFromRecurringModel);
        }
    ...
    public long addUpdateCategoryData(CategoryBean categoryBean) {
        ...
        if (TextUtils.isEmpty(categoryBean.getId())) {
            return this.f70db.insert(Category.TABLE_NAME, null, contentValuesFromCategoryModel);
        }
    ...
    public void addUpdateCategoryByDrod_IdtoOthers(int i, int i2, int i3, String str) {
        String[] strArr = {"" + i, "" + i2};
        Cursor rawQuery = this.f70db.rawQuery("UPDATE categories SET drag_id=drag_id-1 where drag_id<=? AND drag_id!=? AND drag_id>=" + i2 + " AND " + Category.CAT_TYPE + "=" + i3 + " AND account_id=" + str, strArr);
    ...
    public void addUpdateCategoryByDrod_IdtoOthersMove(int i, int i2, String str) {
        String[] strArr = {"" + i};
        Cursor rawQuery = this.f70db.rawQuery("UPDATE categories SET drag_id=drag_id-1 where drag_id>? AND cat_type=" + i2 + " AND account_id=" + str, strArr);
        rawQuery.moveToFirst();
        rawQuery.close();
    }
    ...
    public int getDragIdfromCategoty(int i, String str) {
        int i2;
        Cursor rawQuery = this.f70db.rawQuery("SELECT drag_id FROM  categories WHERE cat_id=" + i + " AND account_id=" + str, null);
    ...
    public void UpdateMoveCategory(String str, String str2) {
        Cursor rawQuery = this.f70db.rawQuery("UPDATE categories SET account_id=? WHERE cat_id=?", new String[]{"" + str2, "" + str});
        rawQuery.moveToFirst();
        rawQuery.close();
    }

    public void UpdateDragIdMoveCategory(String str, int i) {
        Cursor rawQuery = this.f70db.rawQuery("UPDATE categories SET drag_id=?  WHERE cat_id=?", new String[]{"" + i, "" + str});
        rawQuery.moveToFirst();
        rawQuery.close();
    }

    public int getCategoryCount(String str, int i, String str2) {
        Cursor rawQuery = this.f70db.rawQuery("SELECT * FROM  " + str + " WHERE " + Category.CAT_TYPE + "=" + i + " AND account_id=" + str2, null);
    ...
    public void UpdateManagerAccount_id(int i, String str) {
        String[] strArr = {"" + i};
        Cursor rawQuery = this.f70db.rawQuery("UPDATE manager SET account_id=" + str + " where sub_cat=? ", strArr);
        rawQuery.moveToFirst();
        rawQuery.close();
    }
    ...
    public void UpdateRecirringAccount_id(int i, String str) {
        String[] strArr = {"" + i};
        Cursor rawQuery = this.f70db.rawQuery("UPDATE recurring SET account_id=" + str + " where sub_cat=? ", strArr);
        rawQuery.moveToFirst();
        rawQuery.close();
    }
    ...
    public List<CategoryBean> getCategoryList(int i) {
        ...
        Cursor rawQuery = this.f70db.rawQuery("SELECT * FROM categories WHERE cat_type=" + i + " AND account_id=" + this.accountId + " ORDER BY drag_id ASC", null);
        while (rawQuery.moveToNext()) {
    ...
    public List<CategoryBean> getCategoryDESCList() {
        ArrayList arrayList = new ArrayList();
        Cursor rawQuery = this.f70db.rawQuery("SELECT id,amount,cat,cat_id AS cat_id,cat_name AS cat_name,categories.amount_limit AS amount_limit,categories.account_id AS account_id,cat_color AS cat_color FROM manager INNER JOIN categories ON cat_id = sub_cat ORDER BY id DESC ", null);
        while (rawQuery.moveToNext()) {
            CategoryBean categoryModelFromCursor = getCategoryModelFromCursor(rawQuery);
    ...
    public List<CategoryBean> getCategoryRecentList(int i) {
        ArrayList arrayList = new ArrayList();
        Cursor rawQuery = this.f70db.rawQuery("SELECT * FROM categories WHERE cat_type=" + i + " AND account_id=" + this.accountId + " ORDER BY drag_id DESC", null);
        while (rawQuery.moveToNext()) {
            CategoryBean categoryModelFromCursor = getCategoryModelFromCursor(rawQuery);
            if (categoryModelFromCursor.getCategoryLimit().equals("")) {
                categoryModelFromCursor.setCategoryLimit("0");
    ...
    public List<DataBean> getManagerModelList(int i) {
        ArrayList arrayList = new ArrayList();
        Cursor rawQuery = this.f70db.rawQuery("SELECT * FROM manager m INNER JOIN categories e ON e.cat_id=m.sub_cat WHERE m.cat=" + i + " AND m.account_id=" + this.accountId + " ORDER BY date DESC", null);
        while (rawQuery.moveToNext()) {
    ...
    public List<RecurringBean> getRecurringModelList(int i) {
        ArrayList arrayList = new ArrayList();
        Cursor rawQuery = this.f70db.rawQuery("SELECT * FROM recurring m INNER JOIN categories e ON e.cat_id=m.sub_cat WHERE m.cat=" + i + " AND m.account_id=" + this.accountId + " ORDER BY " + RecurringTable.RECURRING_LASTDATE + " DESC", null);
        while (rawQuery.moveToNext()) {
    ...
    public CategoryBean getCategoryModelById(int i, String str) {
        ...
        Cursor rawQuery = this.f70db.rawQuery("SELECT * FROM categories WHERE cat_id=" + str, null);
    ...
    public List<DataBean> getManagerDataByCategoryByTime(int i, String str, String str2, String str3) {
        Cursor rawQuery = this.f70db.rawQuery("select * from manager m inner join categories e on e.cat_id = m.sub_cat where ( m.cat= ? and e.cat_id = ?) and ( date BETWEEN ? and ? )  AND m.account_id=" + this.accountId + " order by date desc", new String[]{String.valueOf(i), str, str2, str3});
        ArrayList arrayList = new ArrayList();
        while (rawQuery.moveToNext()) {
            DataBean managerModelFromCursor = getManagerModelFromCursor(rawQuery);
            CategoryBean categoryModelFromCursor = getCategoryModelFromCursor(rawQuery);
    ...
    public List<DataBean> getManagerDataByTime(int i, String str, String str2) {
        Cursor rawQuery = this.f70db.rawQuery("select * from manager m inner join categories e on e.cat_id = m.sub_cat where ( m.cat= ? ) and ( date BETWEEN ? and ? )  AND m.account_id=" + this.accountId + " order by date desc", new String[]{String.valueOf(i), str, str2});
        ArrayList arrayList = new ArrayList();
        while (rawQuery.moveToNext()) {
            DataBean managerModelFromCursor = getManagerModelFromCursor(rawQuery);
            CategoryBean categoryModelFromCursor = getCategoryModelFromCursor(rawQuery);
    ...
    public Boolean existsColumnInTable() {
        try {
            if (this.f70db.rawQuery("SELECT * FROM categories LIMIT 0", null).getColumnIndex("drag_id") != -1) {
                return true;
            }
            return false;
    ...
    public String getTotalAmountByTime(int i, String str, String str2) {
        Cursor rawQuery = this.f70db.rawQuery("SELECT SUM(amount) FROM manager m INNER JOIN categories e on e.cat_id = m.sub_cat where ( m.cat= ? ) and ( date BETWEEN ? and ? )  AND m.account_id=" + this.accountId + " order by date desc", new String[]{String.valueOf(i), str, str2});
    ...
    public String getCategoryAmount(int i, String str) {
        Cursor rawQuery = this.f70db.rawQuery("SELECT SUM(amount) FROM manager m INNER JOIN categories e on e.cat_id = m.sub_cat where ( m.cat=? ) and ( e.cat_id=? )  AND m.account_id=" + this.accountId, new String[]{String.valueOf(i), str});
        String string = rawQuery.moveToFirst() ? rawQuery.getString(0) : null;
        rawQuery.close();
        return string == null ? "0" : string;
    }
    ...
    public String getCategoryAmount(String str) {
        Cursor rawQuery = this.f70db.rawQuery("SELECT SUM(amount) FROM manager m INNER JOIN categories e on e.cat_id = m.sub_cat where ( e.cat_id=? )  AND m.account_id=" + this.accountId, new String[]{str});
        String string = rawQuery.moveToFirst() ? rawQuery.getString(0) : null;
        rawQuery.close();
        return string == null ? "0" : string;
    }
    ...
    public String getCategoryAmountByTime(int i, String str, String str2, String str3) {
        Cursor rawQuery = this.f70db.rawQuery("SELECT SUM(amount) FROM manager m INNER JOIN categories e on e.cat_id = m.sub_cat where ( m.cat=? ) and ( e.cat_id=? ) and ( date BETWEEN ? and ? )  AND m.account_id=" + this.accountId, new String[]{String.valueOf(i), str, str2, str3});
        String string = rawQuery.moveToFirst() ? rawQuery.getString(0) : null;
        rawQuery.close();
        return string == null ? "0" : string;
    }
    ...
    public long addUpdateTemplateData(TemplateBean templateBean) {
        ...
        if (TextUtils.isEmpty(templateBean.getId())) {
            return this.f70db.insert(TemplatesTable.TABLE_NAME, null, contentValuesFromTemplateModel);
        }
    ...
    public void addcolumn() {
        ...
        Cursor rawQuery = this.f70db.rawQuery("SELECT DISTINCT account_id FROM categories", null);
    ...
    private List<CategoryBean> getOldCategories(String str, int i, String str2, String str3) {
        String[] strArr = {"" + str3};
        ArrayList arrayList = new ArrayList();
        Cursor rawQuery = this.f70db.rawQuery("SELECT * FROM " + str + " WHERE " + Category.CAT_TYPE + " =" + i + " AND account_id=?", strArr);
        while (rawQuery.moveToNext()) {
            CategoryBean categoryBean = new CategoryBean();
    ...
    public TemplateBean getTemplateModelById(String str) {
        ...
        Cursor rawQuery = this.f70db.rawQuery("SELECT * FROM msg_templates WHERE id=" + str, null);
        if (rawQuery.moveToFirst()) {
    ...
    public long addUpdateAccountData(AccountBean accountBean) {
        ...
        if (TextUtils.isEmpty(accountBean.getId())) {
            return this.f70db.insert(AccountTable.TABLE_NAME, null, contentValuesFromAccountModel);
        }
    ...
    private ContentValues getContentValuesFromAccountModel(AccountBean accountBean) {
        ...
        contentValues.put("currency", "" + accountBean.getCurrency());
        return contentValues;
    }
    ...
    public AccountBean getAccountModelById(String str) {
        ...
        Cursor rawQuery = this.f70db.rawQuery("SELECT * FROM account WHERE id=" + str, null);
        if (rawQuery.moveToFirst()) {
    ...
    public AccountBean getAccountModelByName(String str) {
        Cursor rawQuery = this.f70db.rawQuery("SELECT * FROM account WHERE name=?", new String[]{"" + str});
    ...
    public List<AccountBean> getAccountList() {
        ...
        ArrayList arrayList = new ArrayList();
        try {
            Cursor rawQuery = this.f70db.rawQuery("SELECT * FROM account", null);
            while (rawQuery.moveToNext()) {
    ...
    public List<TemplateBean> getTemplateList() {
        ArrayList arrayList = new ArrayList();
        Cursor rawQuery = this.f70db.rawQuery("SELECT * FROM msg_templates", null);
        while (rawQuery.moveToNext()) {
    ...
    public List<TemplateBean> getTemplateListByAccount() {
        ArrayList arrayList = new ArrayList();
        Cursor rawQuery = this.f70db.rawQuery("SELECT * FROM msg_templates WHERE account_id=" + this.accountId, null);
        while (rawQuery.moveToNext()) {
            arrayList.add(getTemplateModelFromCursor(rawQuery));
        }
        rawQuery.close();
    ...
    public Collection<? extends RecurringBean> getRecurringModelList(int i, String str) {
        ArrayList arrayList = new ArrayList();
        Cursor rawQuery = this.f70db.rawQuery("SELECT * FROM recurring m INNER JOIN categories e ON e.cat_id=m.sub_cat WHERE m.cat=" + i + " AND m.account_id=" + this.accountId + " AND e." + Category.CAT_ID + "=" + str + " ORDER BY " + RecurringTable.RECURRING_LASTDATE + " DESC", null);
        while (rawQuery.moveToNext()) {
            RecurringBean recurringModelFromCursor = getRecurringModelFromCursor(rawQuery);
            CategoryBean categoryModelFromCursor = getCategoryModelFromCursor(rawQuery);
            categoryModelFromCursor.setCategoryGroup(i);
    ...
    public long getCategoryIdFromData(CategoryBean categoryBean) {
        Cursor query = this.f70db.query(Category.TABLE_NAME, new String[]{Category.CAT_ID}, "cat_type=? AND account_id=? AND cat_name=? ", new String[]{"" + categoryBean.getCategoryGroup(), categoryBean.getAccountRef(), categoryBean.getName()}, null, null, null);
    ...
    public List<DataBean> getManagerDataByTimeAndCategory(int i, int i2, String str, String str2) {
        Cursor rawQuery = this.f70db.rawQuery("select * from manager m inner join categories e on e.cat_id = m.sub_cat where ( m.cat= ? ) and ( e.cat_id = ? ) and ( date BETWEEN ? and ? )  AND m.account_id=" + this.accountId + " order by date desc", new String[]{String.valueOf(i), String.valueOf(i2), str, str2});
        ArrayList arrayList = new ArrayList();
        while (rawQuery.moveToNext()) {
            DataBean managerModelFromCursor = getManagerModelFromCursor(rawQuery);
            CategoryBean categoryModelFromCursor = getCategoryModelFromCursor(rawQuery);
    ...
    public int isFieldExist(String str) {
        SQLiteDatabase sQLiteDatabase = this.f70db;
        return sQLiteDatabase.rawQuery("PRAGMA table_info(" + str + ")", null).getColumnCount();
    }
    ...
    public class ManagerDBHelper extends SQLiteOpenHelper {
        ...
        public void onCreate(SQLiteDatabase sQLiteDatabase) {
            MyDatabaseHandler.this.f70db = sQLiteDatabase;
        ...
        private void updateDatabaseFromVerson6() {
            Cursor rawQuery = MyDatabaseHandler.this.f70db.rawQuery("SELECT DISTINCT account_id FROM categories", null);
            PrintStream printStream = System.out;
            printStream.println("Total account" + rawQuery.getCount());
            Log.e("Total account:", "" + rawQuery.getCount());
            if (rawQuery != null) {
        ...
        private void updateCategtoryDataAndReference(CategoryBean categoryBean) {
            ...
            String str2 = "UPDATE manager SET sub_cat=" + str + " WHERE cat=" + String.valueOf(categoryGroup) + " AND sub_cat=" + id;
            String str3 = "UPDATE recurring SET sub_cat=" + str + " WHERE cat=" + String.valueOf(categoryGroup) + " AND sub_cat=" + id;


            MyDatabaseHandler.this.f70db.execSQL(str2);
            MyDatabaseHandler.this.f70db.execSQL(str3);
        }

        private List<CategoryBean> getOldCategories(String str, int i, String str2, String str3) {
            String[] strArr = {"" + str3};
            ArrayList arrayList = new ArrayList();
            Cursor rawQuery = MyDatabaseHandler.this.f70db.rawQuery("SELECT * FROM " + str + " WHERE " + Category.CAT_TYPE + " =" + i + " AND account_id=?", strArr);
            while (rawQuery.moveToNext()) {
                CategoryBean categoryBean = new CategoryBean();
                categoryBean.setId(rawQuery.getString(rawQuery.getColumnIndex(Category.CAT_ID)));
                categoryBean.setName(rawQuery.getString(rawQuery.getColumnIndex(Category.CAT_NAME)));
        ...
        private List<CategoryBean> getOldCategories(String str, int i, String str2) {
            ArrayList arrayList = new ArrayList();
            Cursor rawQuery = MyDatabaseHandler.this.f70db.rawQuery("SELECT * FROM " + str + " WHERE " + Category.CAT_TYPE + " =" + i + " AND account_id=?", new String[]{"2"});
            while (rawQuery.moveToNext()) {
                CategoryBean categoryBean = new CategoryBean();
                categoryBean.setId(rawQuery.getString(rawQuery.getColumnIndex(Category.CAT_ID)));
                categoryBean.setName(rawQuery.getString(rawQuery.getColumnIndex(Category.CAT_NAME)));
