...
public class EpesodTAFASIL extends AppCompatActivity {
    ...
    String title;
    String name,CartoonTitle,Epesodetitle,hdlink,postkey,epetitle,type,fhdlink,sdlink,qdlink;
    ...
    private void watchVideo2(String url){
        ...
        sendDataToDetailsActivity.putExtra("eName",Epesodetitle);
        sendDataToDetailsActivity.putExtra("message","");
        sendDataToDetailsActivity.putExtra("position",String.valueOf(positiondn));
        sendDataToDetailsActivity.putExtra("type",type);
        sendDataToDetailsActivity.putExtra("epetitle",epetitle);
        sendDataToDetailsActivity.putExtra("fhd",fhdlink);
        sendDataToDetailsActivity.putExtra("hd",hdlink);
        sendDataToDetailsActivity.putExtra("sd",sdlink);
        sendDataToDetailsActivity.putExtra("qd",qdlink);
        sendDataToDetailsActivity.putExtra("key",postkey);
        sendDataToDetailsActivity.putExtra("name",name);
        ...
        sendDataToDetailsActivity.putExtra("story",story);
    ...
    String posterid,titlecartoon,id,poste,place,age,studio,date,story,cast,tasnif,where,mortabit_id,chapters,positionEpes0de;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        titlecartoon = getIntent().getStringExtra("title");
        ...
        mortabit_id = getIntent().getStringExtra("mortabit");
        chapters = getIntent().getStringExtra("link");
    ...
    private void SetEpeLinks(EpesodModel epesodModel) {
        Epesodetitle = epesodModel.getEpetitle();
        ...
        namechrabar.setText(epesodModel.getEpetitle());

        reportnotepe.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                SendReport(postkey,name + " - " + epesodModel.getEpetitle());
        ...
        fhdtitle.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (!sp.getString("ispaid", "0").equals("1")){
                    OpenDialog(epesodModel.getServer1());
                }else {
                    letGo2(epesodModel.getServer1());
                }
        ...
        hdtitle.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (!sp.getString("ispaid", "0").equals("1")){
                    OpenDialog(epesodModel.getServer2());
                }else {
                    letGo2(epesodModel.getServer2());
                }
        ...
        sdtitle.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (!sp.getString("ispaid", "0").equals("1")){
                    OpenDialog(epesodModel.getServer3());
                }else {
                    letGo2(epesodModel.getServer3());
                }
    ...
    private void multipleQualityDialog2(ArrayList<Jmodel> model) {
        ...
        for (int i = 0; i <  model.size(); i++) {
            ...
            downloadit.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (ContextCompat.checkSelfPermission(EpesodTAFASIL.this, Manifest.permission.WRITE_EXTERNAL_STORAGE) == PackageManager.PERMISSION_GRANTED) {
                        String fulltitle = CartoonTitle +" - "+ Epesodetitle+".mp4";

                        switch (sp.getInt("downcartoonselect",0)){

                            case 0:

                                SingleDownloadepe(model.get(fi).getUrl(),CartoonTitle,Epesodetitle,EpesodTAFASIL.this);
