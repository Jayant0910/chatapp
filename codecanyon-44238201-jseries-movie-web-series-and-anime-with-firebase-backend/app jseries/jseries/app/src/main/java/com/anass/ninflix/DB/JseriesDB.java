...
public class JseriesDB extends SQLiteOpenHelper {
    ...
    public boolean AddtoMyListdDB(SerieModel comicsModel){
        ...
        cv.put(POSTERKEY,comicsModel.getSerie_id());
        ...
        cv.put("rating",comicsModel.getYoutubetrailerid());
        cv.put("userid",comicsModel.getUserid());
    ...
    public boolean AddCountineWatchingDB(CountinuModel comicsModel){
        ...
        ContentValues cv = new ContentValues();
        cv.put(TITLE,comicsModel.getTitle());
        cv.put(POSTERKEY,comicsModel.getPostkey());
        cv.put(POSTER,comicsModel.getImage());
        cv.put(YEAR,comicsModel.getDate());
        cv.put(GENER,comicsModel.getTasnifh());
        cv.put(STUDIO,comicsModel.getStudio());
        cv.put(AGE,comicsModel.getAge());
        cv.put(STORY,comicsModel.getDesc());
        cv.put(WHERESTART,comicsModel.getAlmotarjim());
        cv.put(PLACE,comicsModel.getSeasons());
        cv.put(CAST,comicsModel.getCast());
        cv.put(MORTABIT,comicsModel.getEpesodes());
        cv.put(CHAPTERS,comicsModel.getLink());

        cv.put("epename",comicsModel.getEpetitle());
        cv.put("wherehestop",comicsModel.getCurrnt());
        cv.put("totallenght",comicsModel.getDuration());
        cv.put("fhd",comicsModel.getServer1());
        cv.put("hd",comicsModel.getServer2());
        cv.put("sd",comicsModel.getServer3());
        cv.put("postkey",comicsModel.getPostkey());
        cv.put("position",comicsModel.getPosit());
    ...
    public boolean AddCheckEpeDB(CountinuModel comicsModel){
        ...
        cv.put(POSTERKEY,comicsModel.getPostkey());
        cv.put("epename",comicsModel.getEpetitle());
        cv.put("epepostkey",comicsModel.getPostkeyEpe());
    ...
    public boolean UpdateMyListDB(SerieModel comicsModel){
        ...
        float res = db.update(TABLENAMESERIES,cv,POSTERKEY+" =?",new String[] {comicsModel.getSerie_id()});
    ...
    public boolean UpdatedownloadDB(SerieModel comicsModel){
        ...
        float res = db.update(TABLENAMECARTOON,cv,POSTERKEY+" =?",new String[] {comicsModel.getSerie_id()});
    ...
    public boolean UpdateCountinuDB(CountinuModel comicsModel){
        ...
        float res = db.update(TABLENAMECOUNTINIWATCHING,cv,POSTERKEY+" =?",new String[] {comicsModel.getPostkey()});
    ...
    public boolean UpdateCheckEpeDB(CountinuModel comicsModel){
        SQLiteDatabase db = this.getWritableDatabase();
        ...
        float res = db.update(TABLENAMECHECKEPE,cv,"epepostkey =?",new String[] {comicsModel.getPostkeyEpe()});
