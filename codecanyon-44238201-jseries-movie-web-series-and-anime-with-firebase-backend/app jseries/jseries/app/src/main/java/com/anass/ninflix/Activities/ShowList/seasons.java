...
public class seasons extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        CheckifThereSeaons(posterid,mortabit_id);
    ...
    private void CheckifThereSeaons(String postkey,String mortabit_id) {
        ...
        allseriesandmovies.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for (DataSnapshot ss:snapshot.getChildren()) {
                    ...
                    if (sp.getOther_season_id().equals(mortabit_id) && !sp.getSerie_id().equals(postkey)){
