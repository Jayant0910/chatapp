...
public class SliderAdapter extends
    ...
    public void onBindViewHolder(SliderAdapterVH viewHolder, int position) {
        ...
        viewHolder.watchepenoew.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DatabaseReference db = FirebaseDatabase.getInstance().getReference("Views").child(w.getSerie_id()).child("views");
                ...
                sendDataToDetailsActivity.putExtra("youtubeid",w.getYoutubetrailerid());
        ...
        viewHolder.addtofv.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ...
                if (FirebaseAuth.getInstance().getCurrentUser() == null){
                    ...
                    serieModel.setYoutubetrailerid(w.getYoutubetrailerid());
                    serieModel.setViews(w.getViews());
                    ...
                    serieModel.setOther_season_id(w.getOther_season_id());
                    serieModel.setTitle(w.getTitle());
                    serieModel.setCast(w.getCast());
                    serieModel.setLink_id(w.getLink_id());
                    serieModel.setUserid(w.getUserid());
    ...
    public class SliderAdapterVH extends ViewHolder {
        ...
        RelativeLayout watchepenoew,progreswait;
        Boolean IsInMyFavoritnow = false;
        ...
        public SliderAdapterVH(View itemView) {
            ...
            gotoinfo = itemView.findViewById(R.id.gotoinfo);
